# VKR: оптимизация распределения нагрузки на серверы

Проект посвящён оптимизации распределения нагрузки/задач на серверы с использованием ML: прогнозирование временных рядов (LSTM) и сравнение методов кластеризации. Цель — унифицировать данные из разных трасс, построить качественный пайплайн предобработки и подготовить основу для дальнейшего моделирования.
